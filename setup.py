...
if __name__ == '__main__':
    ...
    setup(
        ...
        ext_modules=[
            ...
            make_cuda_ext(
                name='mirror_sigmoid_focal_loss_cuda',
                module='mmdet.ops.mirror_sigmoid_focal_loss',
                sources=['src/mirror_sigmoid_focal_loss.cpp',
                         'src/mirror_sigmoid_focal_loss_cuda.cu']),
        ],
